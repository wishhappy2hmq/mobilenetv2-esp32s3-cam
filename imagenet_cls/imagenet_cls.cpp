...
#endif
    // 使用二分类后处理器
    m_postprocessor = new dl::cls::BinaryClsPostprocessor(m_model, topk, score_thr, true);
}
} // namespace imagenet_cls
...
void ImageNetCls::load_model()
{
    ...
    case model_type_t::MOBILENETV2_S8_V1:
        ...
        m_model = new imagenet_cls::MobileNetV2("image_classifier_320x320_int8.espdl", m_topk, m_score_thr);
#else
        ESP_LOGE("imagenet_cls", "image_classifier_320x320_int8 is not selected in menuconfig.");
#endif
        break;
    }
}
